...
- **ZOD:** Jeg velger å bruke zod for data validation, og gjør den så presis som mulig, med blant annet skikkelig epostsjekk med .email() og telefonnummer sjekk med .e164(). Den er streng, men likevel så fleksibel som jeg mener den bør være for kravene.
