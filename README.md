...
De faste stoppestedene defineres som ['Bergen', 'Stavanger', 'Hirtshals', 'Kristiansand']. Jeg ønsker å ta legs i betraktning allerede herfra for å unngå konflikt i modellen senere. Selv om det alltid kan bli konflikter og endringer, er det bedre å ha et så grundig grunnlag som mulig.
